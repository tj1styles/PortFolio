...
const Sidebar = () => {
  const links = [
    ...
    { id: 2, icons: <BiLogoTwitter />, links: "https://x.com/TehillahJa89535" },
    {
      id: 3,
      icons: <LiaLinkedinIn />,
  ...
  console.log(getYear);
  return (
    <div className="xl:h-full  border-[0.2vw] border-[rgb(86,86,86)] w-[100%] xl:w-[100%] xl:border-y-[0px] flex flex-col  space-y-[3vw] items-center text-white lg:p-[6%] lg:rounded-[6%] xl:px-[2vw] ">
      <div className="w-full flex flex-row justify-evenly pt-[1vw]">
        <div className="w-[50%] flex space-x-[1vw]">
          <span className="lg:text-[28px] xl:text-[2.4vw] font-bold">UKNIC</span>
          <span className="lg:w-[3vh] lg:h-[3vh] xl:w-[1.9vw] flex items-center justify-center xl:h-[1.9vw] border-[0.2vw] border-[white] rounded-full lg:text-[12px] xl:text-[0.9vw]">
            U
          </span>
        </div>
        <div className="w-[45%] text-right">
          <span className="lg:text-[16px] xl:text-[1.1vw]">
            Web Developer, Game Developer, A.I Enthusiast and Animation Designer
          </span>
        </div>
      </div>

      <div className="lg:w-[55%] xl:w-[60%] lg:h-[30vh] lg:rounded-[10%]  xl:rounded-[1vw] xl:h-[30vh]  object-cover overflow-hidden">
        <img
          src={green_suit}
          className="w-full green_suit translate-y-[-2vw]"
          alt=""
        />
      </div>
      <div className="w-full text-center text-[2.3vw] space-y-[0.5vw]">
        ...
        <p className="text-[1.2vw] text-[rgb(139,139,139)]">
          &copy; {getYear} Uknic. All Rights Reserved
        </p>
      </div>

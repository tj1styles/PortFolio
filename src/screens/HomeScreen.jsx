...
const HomeScreen = () => {
  return (
    <div className="bg-[hsl(0,0%,12%)] lg:items-center lg:p-[5%] xl:h-[100vh] w-[100%] xl:w-[100vw] flex flex-col xl:flex-row">
      <div className="lg:w-[65%] xl:w-[30vw] xl:h-[100vh]  xl:pl-[1.7vw] relative">
        <Sidebar />
